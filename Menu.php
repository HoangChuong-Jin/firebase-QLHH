<div class="left-side">
    ...
    <div class="left-content">
        ...
        <?php 
            ...
            {
        ?>
            <li role="presentation" ><a href="DangNhap.php" role="nav-link" data-toggle="nav-link"><span><i class="fa fa-home"></i></span>Đăng nhập</a></li>
        <?php
            }
            else
            {
        ?>     
            ...
            <li role="presentation" class="hover"><a href="HH_DS_Nhap.php"><span><i class="fa fa-file"></i></span>Danh sách nhập</a></li>
